...
echo $yellow
figlet -f future "UNDERGROUND SCIENCE"
echo
echo $red"##########################$green" WELCOME "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"LU"$cyan" ~/KNTL"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo $green "╭─"$blue"KNTL"$cyan" ~/Nama SC Harus (index.html) ganti dulu sana"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"KNTL"$cyan" ~/LU"$white                               
read -p " ╰─$ " script
echo
echo
...
echo $white "╭─"$green"KNTL"$cyan" ~/Crot"$white
read -p " ╰─$ " target5
...
echo $red"##########################$green" WELCOME "$red###########################"
echo $green"Author   : Muhamad Royyani		"
echo $purple"Gthub   : https://github.com/MrBarBar05"
echo $white"WhatsApp : 085693587968"
echo
...
echo $white"[+] All Member [UNDERGROUND SCIENCE] "
echo $red"##########################$green" WELCOME "$red###########################"
