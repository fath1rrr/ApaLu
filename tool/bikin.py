...
print
time.sleep(1)
kntl(G+'Hallo Jing, kali ini gue buat tools Deface :)')
kntl(C+'Cie yang gak tau buat sc deface...')
print
kntl('Masukan Title')
title = raw_input('Title/Judul : ')
print
kntl('Masukan Nama underground')
heading = raw_input('Nama Underground : ')
print
kntl('Masukan Link Gambar')
imagelink = raw_input('link gambar : ')
print
kntl('Masukan Pesan masukan <br> untuk teks lanjutan')
pesan = raw_input('Pesan : ')
print
kntl('Masukan Warna Teks')
...
kntl('File Disimpan dengan format script.html')
